...
describe('html-to-vdom', function () {
    ...
    describe('when converting an svg tag', function () {
        var svg1 = convertHTML(
            '<svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" height="180.903" width="220.34801" version="1.1" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">' + 
                '<metadata>' + 
                    '<rdf:RDF>' + 
                        '<cc:Work rdf:about="">' + 
        ...
        var svg2 = convertHTML(
            '<svg height="32px" aria-labelledby="navigation-svg-title" style="enable-background:new 0 0 32 32;" version="1.1" viewBox="0 0 32 32" width="32px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' +
                '<title id="navigation-svg-title">Menu</title>' + 
                '<path class="c-small-navigation__icon" d="M4,10h24c1.104,0,2-0.896,2-2s-0.896-2-2-2H4C2.896,6,2,6.896,2,8S2.896,10,4,10z M28,14H4c-1.104,0-2,0.896-2,2  s0.896,2,2,2h24c1.104,0,2-0.896,2-2S29.104,14,28,14z M28,22H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h24c1.104,0,2-0.896,2-2  S29.104,22,28,22z"/>' +
            '</svg>');
