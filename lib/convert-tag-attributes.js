...
var flippedObject = function (obj) {
    var flipped = {};
...
var propertyToAttributeMapping = flippedObject(attributeToPropertyMapping);
...
var convertTagAttributes = function (tag) {
    ...
    Object.keys(attributes).forEach(function (attributeName) {
        ...
        // Anything we don't set as an attribute is a property
        else {
            if (propInfo.hasBooleanValue) {
                var isTrue = (value === '' || value.toLowerCase() === propInfo.attributeName);
